...
def ResNet50_224(input_shape=(224,224,3),classes=2):
    ...
    y = layers.Conv2D(32, (224, 1), padding='same',name='conv1_RF_0')(img_input)
    y = layers.BatchNormalization(axis=bn_axis, name='bn_conv1_RF_0')(y)
    y = layers.Activation('relu')(y)



    y = layers.Conv2D(64, (224, 1), padding='valid',name='conv1_RF_1')(y)
    y = layers.BatchNormalization(axis=bn_axis, name='bn_conv1_RF_1')(y)
    y = layers.Activation('relu')(y)

    y = layers.Conv2D(1, (1, 1), padding='valid',name='conv1_RF_2')(y)
    y = layers.BatchNormalization(axis=bn_axis, name='bn_conv1_RF_2')(y)
    y = layers.Activation('relu')(y)
...
model = ResNet50_224(input_shape=(224,224,3),classes=2)
...
n = 0
# model.load_weights('/mnt/data/VGG_ultrasound/RF/spectrogram/RF3/resnet/model/incept_24501.h5')
