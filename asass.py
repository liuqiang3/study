...
#0.8745098039215686  22501   /5
# ACC:0.9117647058823529
# the precision is [0.8671328671328671]
# the recall is [0.9725490196078431]
# the sensitivity is [0.9725490196078431]
# the specificity is [0.8509803921568627]
    for i in range(1,9501,500):
        print(i)
        saver.restore(sess,'/mnt/data/VGG_ultrasound/RF/spectrogram/RF3/ill/5_cross_vaildation/model/1/model.ckpt-{}'.format(i))

    ## 39001 0.86
        img_path = '/mnt/data/VGG_ultrasound/RF/spectrogram/RF3/ill/5_cross_vaildation/data/1/'
