...
with tf.Session() as sess:
    ...
    saver.restore(sess,'/mnt/data/VGG_ultrasound/RF/spectrogram/RF3/ill/5_cross_vaildation/model/1/model.ckpt-19501')

## 39001 0.86
    img_path = '/mnt/data/VGG_ultrasound/RF/spectrogram/RF3/ill/5_cross_vaildation/data/2/'
